...
void inline clamp_by_vector(arma::vec &B, const arma::vec& lows, const arma::vec& highs){
...
arma::rowvec inline matrix_center(const arma::sp_mat& X, arma::sp_mat& X_normalized,
        bool intercept){
    auto p = X.n_cols;
