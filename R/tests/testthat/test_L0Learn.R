...
test_that("The fit and cvfit gracefully error on bad rtol.", {
  ...
  f1 <- function() {
    L0Learn.fit(X, y, rtol = 1.1)
  }
  f2 <- function() {
    L0Learn.fit(X, y, rtol = -.1)
  }
  f3 <- function() {
    L0Learn.fit(X, y, atol = -.1)
  }
  f4 <- function() {
    L0Learn.cvfit(X, y, rtol = 1.1)
  }
  f5 <- function() {
    L0Learn.cvfit(X, y, rtol = -.1)
  }
  f6 <- function() {
    L0Learn.cvfit(X, y, atol = -.1)
  }
...
test_that("The fit and cvfit gracefully error on bad loss specifications", {
  ...
  f1 <- function() {
    L0Learn.fit(X, y, loss = "NOT A LOSS")
  }
  f2 <- function() {
    L0Learn.cvfit(X, y, loss = "NOT A LOSS")
  }
...
test_that("The fit and cvfit gracefully error on bad penalty specifications", {
  ...
  f1 <- function() {
    L0Learn.fit(X, y, penalty = "NOT A PENALTY")
  }
  f2 <- function() {
    L0Learn.cvfit(X, y, penalty = "NOT A PENALTY")
  }
...
test_that("The fit and cvfit gracefully error on bad algorithim specifications", {
  ...
  f1 <- function() {
    L0Learn.fit(X, y, algorithm = "NOT A ALGO")
  }
  f2 <- function() {
    L0Learn.cvfit(X, y, algorithm = "NOT A ALGO")
  }
...
test_that("The fit and cvfit gracefully error on non classifcation y when for classicaiton", {
  ...
  f1 <- function() {
    L0Learn.fit(X, y, loss = "Logistic")
  }
  f2 <- function() {
    L0Learn.fit(X, y, loss = "SquaredHinge")
  }
  f1 <- function() {
    L0Learn.cvfit(X, y, loss = "Logistic")
  }
  f2 <- function() {
    L0Learn.cvfit(X, y, loss = "SquaredHinge")
  }
...
test_that("The fit and cvfit gracefully error on L0 classifcation when lambdagrid is the wrong size", {
  ...
  f1 <- function() {
    L0Learn.fit(X, sign(y), loss = "Logistic", penalty = "L0", lambdaGrid = lambda_grid)
  }
  f2 <- function() {
    L0Learn.fit(X, sign(y), loss = "SquaredHinge", penalty = "L0", lambdaGrid = lambda_grid)
  }
  f1 <- function() {
    L0Learn.cvfit(X, sign(y), loss = "Logistic", penalty = "L0", lambdaGrid = lambda_grid)
  }
  f2 <- function() {
    L0Learn.cvfit(X, sign(y), loss = "SquaredHinge", penalty = "L0", lambdaGrid = lambda_grid)
  }
...
test_that("The fit and cvfit gracefully error on L0 when lambdagrid is the wrong size", {
  ...
  lambda_grid[[2]] <- c(10:1)
  f1 <- function() {
    L0Learn.fit(X, y, penalty = "L0", lambdaGrid = lambda_grid)
  }
  f2 <- function() {
    L0Learn.cvfit(X, y, penalty = "L0", lambdaGrid = lambda_grid)
  }
...
test_that("The fit and cvfit gracefully error on L0LX when lambdagrid has not decreasing values", {
  ...
  lambda_grid[[1]] <- c(1:10)
  f1 <- function() {
    L0Learn.fit(X, y, penalty = "L0L1", lambdaGrid = lambda_grid)
  }
  f2 <- function() {
    L0Learn.cvfit(X, y, penalty = "L0L1", lambdaGrid = lambda_grid)
  }
  f3 <- function() {
    L0Learn.fit(X, y, penalty = "L0L2", lambdaGrid = lambda_grid)
  }
  f4 <- function() {
    L0Learn.cvfit(X, y, penalty = "L0L2", lambdaGrid = lambda_grid)
  }
...
test_that("The fit and cvfit gracefully error on CDPSI when bounds are supplied", {
  ...
  f2 <- function() {
    L0Learn.cvfit(X, y, algorithm = "CDPSI", lows = 0)
  }
