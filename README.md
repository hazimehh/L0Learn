...
The latest version of L0Learn (v1.0.6) can be installed directly from Github using
```
library(devtools)
install_github("hazimehh/L0Learn")
```
L0Learn v1.0.2 is also available on CRAN. For a tutorial, please refer to [L0Learn's Vignette](http://www.mit.edu/~hazimeh/L0Learn-vignette.html). For a detailed description of the API, check the [Reference Manual](https://cran.r-project.org/web/packages/L0Learn/L0Learn.pdf).
