...
## Advanced Options
For more advanced options supported by `L0Learn`, please refer to the [Reference Manual](https://cran.r-project.org/web/packages/L0Learn/L0Learn.pdf), which contains a detailed description of the API.
